...
;							mask = mask, xstage1 = xstage1, ystage1 = ystage1, $
;							threshold = threshold)
; INPUTS:
...
;		Bin			: Number of frames to be added together
;		Mask		: Create a mask for the data if we want to only use part.
;		Stellar		: Use to register with point sources, otherwise it will use
